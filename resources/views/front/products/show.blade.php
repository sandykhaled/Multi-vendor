                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        <ul class="breadcrumb-nav">
                            ...
                            <li><a href="{{route('products.index')}}"><i class="lni lni-home"></i>Shop Now!</a></li>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                            ...
                            <p class="category"><i class="lni lni-tag"></i> Drones:<a href="javascript:void(0)">{{$product->category_name}}</a></p>
