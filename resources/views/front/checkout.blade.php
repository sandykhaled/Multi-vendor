                                ...
                                <li>
                                    ...
                                    <section class="checkout-steps-form-content collapse show" id="collapseThree" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                        <div class="row">
                                                ...
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 form-input form">
                                                            <x-form.input name="address[billing][first_name]" placeholder="Last Name" />
                                                        </div>
                                                        <div class="col-md-6 form-input form">
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="form-input form">
                                                        <x-form.input name="address[billing][email]" placeholder="Email addresse" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-12">
                                                <div class="single-form form-default">
                                                    <label>Mailing addresse</label>
                                                    <div class="form-input form">
                                                        <x-form.input name="address[billing][street_address]" placeholder="Mailing addresse" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    <label>Country</label>
                                                    <div class="form-input form">
                                                        <x-form.select name="address[billing][country]" :options="$countryNames" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    <label>Country</label>
                                                    <div class="form-input form">
                                                        <x-form.select name="address[shipping][country]" :options="$countryNames" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
